...
namespace Snap.Api
{
    ...
    public interface ISnapAssembler
    {
        ...
        /// <param name="lines">Individual lines of ASM code. Must not contain newlines. Empty lines are ignored. Neither the list nor its elements may be null.</param>
        /// <returns>Non-null ISnapOutput instance containing the result of the assembly.</returns>
